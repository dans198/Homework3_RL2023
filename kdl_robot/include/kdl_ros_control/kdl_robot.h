...
public:
    ...
    //Added functions
    Eigen::Matrix<double,6,7> getJacobian();
    KDL::Frame getCartesianPose();
    KDL::Twist getCartesianVelocity();
    Eigen::Matrix<double,6,1> getJacDotqDot();
    KDL::JntArray getDesVel(KDL::Twist des_cart_vel,KDL::Jacobian J_cam);
